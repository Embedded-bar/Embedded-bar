...
### 2025
#### EBB №4 ~~25 Apr 25~~ 
- **Всеволод Морозов** Senior Product Manager at ServiceTitan: "Эволюция требований в ходе работы над продуктам"
- **Илья Оразов** Embedded Software Engineer at akYtec: "Precision Time Protocol: когда миллисекунд уже недостаточно"
- **Карсеев Антон** Embedded Engineer at nao.design: "Что там по Embedded SDK?"
#### EBB №3 ~~10-Jan-25~~
